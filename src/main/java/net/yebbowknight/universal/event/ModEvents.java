...
public class ModEvents {
    ...
    public static void onPlayerCloneEvent(PlayerEvent.Clone event) {
        if(!event.getOriginal().getLevel().isClientSide()) {
            event.getEntity().getPersistentData().putIntArray(Crossovermod.MOD_ID + "homepos",
   ...
   // @SubscribeEvent
   // @OnlyIn(Dist.CLIENT)
   // public static void openGui(screenopenup event) {
   ...
   //         event.Screen(new KaupenTitleScreen());
   //     }
   // }
